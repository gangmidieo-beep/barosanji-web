  ...
  return (
    <footer className="mt-10 border-t border-gray-200 bg-gray-50">
      <div className="px-4 py-8 text-xs text-gray-500 leading-relaxed">
        ...
        <p>상호명: 패션피플 &nbsp;|&nbsp; 대표: 노윤하 &nbsp;|&nbsp; 사업자등록번호: 298-03-00947</p>
        <p>통신판매업신고: 2019-인천계양-0650 &nbsp;|&nbsp; 개인정보관리책임자: 노윤하</p>
        <p>주소: 인천시 계양구 장제로663번길 13, 101-101</p>
        <p>
          고객센터: 010-5758-9396 (평일 09:00~18:00, 주말/공휴일 휴무) &nbsp;|&nbsp; 이메일:
          gangmidieo@gmail.com
        </p>
